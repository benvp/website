defmodule BenvpWeb.PageLive do
  ...
  def render(assigns) do
    ...
    >
      <div class="py-8 px-8 sm:px-16 lg:px-0 overflow-x-hidden">
        <div class="absolute inset-[0] lg:inset-[-40px] top-[320px] sm:top-[40px] lg:top-[280px] bg-[url('/images/bg-wave.svg')] bg-cover bg-center opacity-70 select-none -z-10">
        </div>
  ...
  defp hero(assigns) do
    ...
    <div class="mt-8 sm:mt-20 max-w-screen-md mx-auto text-white relative">
      <div class="relative -z-10">
        <div class="absolute bg-[url('/images/code-window.png')] bg-contain bg-center px-6 -mx-6 sm:px-0 sm:mx-0 bg-no-repeat top-[-50px] sm:top-[-90px] right-0 w-[250px] sm:w-[350px] h-[250px] sm:h-[350px]">
        </div>

        <div class="absolute -z-20 w-[500px] h-[500px] top-[-140px] left-[-140px] bg-[url('/images/hero-aurora.png')] bg-cover bg-center">
        </div>
      </div>
      ...
      <div class="relative">
        <div class="p-5 w-28 h-28 flex justify-center items-center rounded-full bg-gray-800 z-10">
          <img
            src={Routes.static_path(BenvpWeb.Endpoint, "/images/me.png")}
            class="object-center object-contain select-none pointer-events-none"
          />
        </div>
      </div>

      <h1 class="mt-16 sm:mt-6 text-benvp-text text-4xl font-title font-bold leading-tight">
        Hey, I'm Ben.<span class="w-1.5 h-8 inline-block ml-2 bg-benvp-green"></span>
        <br />
        I code <span class="text-benvp-red">React</span> daily, like pretty UIs
        <br />
      ...
      <div class="h-full flex items-center justify-center ff-backdrop-blur">
        <div class="flex-1 w-full h-full px-6 py-6 sm:py-5 backdrop-blur-[72px] sm:rounded-lg border border-white border-opacity-5">
          <div class="flex items-center">
            ...
            <h2 class="flex-1 sm:text-center font-bold font-mono text-gray-200 text-sm">
            ...
            <.prompt title="2022/live_motion">
              <:line>
                ...
                <.terminal_line>
                  <a
                    class="terminal-link"
                    href="https://github.com/benvp/live_motion"
                    rel="noreferrer"
                    target="_blank"
                  >
                    GitHub
  ...
  defp terminal_line(assigns) do
    ...
    <p class="font-mono break-before-right">
      <span class="select-none">~</span><span class="ml-2 select-none">#</span>
  ...
  defp section_title(assigns) do
    ...
    <div>
      ...
      <img
        class="ml-2 -mt-2 w-[150px]"
        src={Routes.static_path(BenvpWeb.Endpoint, "/images/blog-decoration.svg")}
      />
    </div>
    """
  end
  ...
  defp blog_entry(assigns) do
    ...
    <article>
      <h2>
        <%= live_redirect(@title,
          to: Routes.live_path(BenvpWeb.Endpoint, BenvpWeb.PostLive, @slug),
          class: "font-bold text-2xl underline decoration-2 decoration-benvp-green"
        ) %>
      </h2>
